...
// into the client lib.
//
class pycbcc_logger_sink : public spdlog::sinks::sink
{
public:
  pycbcc_logger_sink(PyObject* pyObj_logger)
  ...
  pycbcc_logger_sink(const pycbcc_logger_sink&) = delete;
  pycbcc_logger_sink(pycbcc_logger_sink&&) = delete;

  pycbcc_logger_sink& operator=(const pycbcc_logger_sink&) = delete;
  pycbcc_logger_sink& operator=(pycbcc_logger_sink&&) = delete;
