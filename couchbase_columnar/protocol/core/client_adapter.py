...
class BlockingWrapper:
    ...
    @classmethod
    def block(cls,  # noqa: C901
              return_cls: Literal[True]
              ) -> Callable[[InputWrappedFunc[ReqT]], OutputWrappedFunc[ReqT]]:
        """
            **INTERNAL**
        """

        def decorator(fn: InputWrappedFunc[ReqT]) -> OutputWrappedFunc[ReqT]:  # noqa: C901:
            @wraps(fn)
...
class _ClientAdapter:
    ...
    def close_connection(self, req: CloseConnectionRequest) -> None:
        """
            **INTERNAL**
        """
