...
class ClusterOptionsTestSuite:
    ...
    def test_options_deserializer_kwargs(self, event_loop: AbstractEventLoop) -> None:
        cred = Credential.from_username_and_password('Administrator', 'password')
        default_deserializer = DefaultJsonDeserializer()
    ...
    def test_security_options_kwargs(self,
                                     event_loop: AbstractEventLoop,
                                     opts: Dict[str, object],
                                     expected_opts: Dict[str, object]) -> None:
        cred = Credential.from_username_and_password('Administrator', 'password')
    ...
    def test_security_options_invalid_kwargs(self, event_loop: AbstractEventLoop, opts: Dict[str, object]) -> None:
        cred = Credential.from_username_and_password('Administrator', 'password')
        with pytest.raises(ValueError):
